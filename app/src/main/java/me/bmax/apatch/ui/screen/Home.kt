...
// ----------- Miuix‑KMP 导入（重点，ScrollBehavior就在这里）-----------
...
import top.yukonga.miuix.kmp.basic.ScrollBehavior // ✅修复Unresolved reference关键导入
...
// ========= ClassicHomeScreen 迁移到此，原HomeClassic.kt删除 =========
@Composable
